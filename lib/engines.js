...
const ENGINES = {
  claude: {
    label: "Claude Code", bin: "claude", kind: "stream", paid: true, ctx: 200000, model: "opus", models: ["opus", "sonnet", "haiku", "fable"],
  ...
  gemini: {
    label: "Gemini CLI", bin: "gemini", kind: "cli", proto: "gemini-json", paid: true, ctx: 1000000, model: "gemini-2.5-pro", models: ["gemini-2.5-pro", "gemini-2.5-flash"],
    caps: { model: true },
  ...
  codex: {
    label: "Codex CLI", bin: "codex", kind: "cli", proto: "codex-json", paid: true, ctx: 272000, model: "gpt-5-codex", models: ["gpt-5-codex", "gpt-5", "o4-mini"],
    caps: { model: true },
  ...
  opencode: {
    label: "OpenCode", bin: "opencode", kind: "cli", paid: true, ctx: 200000, model: "", models: [],
    caps: { model: true },
  ...
  aider: {
    label: "Aider", bin: "aider", kind: "cli", paid: true, ctx: 200000, model: "", models: [],
    caps: { model: true },
  ...
  ollama: {
    label: "Ollama (local)", bin: "ollama", kind: "local", paid: false, ctx: 8192,
    caps: { model: true, cowork: true },
    tips: ["this AI runs 100% on your machine — private, offline-capable, and free", "no token charges here — the meter shows estimated local tokens only", "switch local models anytime with /model (e.g. qwen2.5-coder, hermes3)", "local models have no external rate limits — run as long as you like", "it has full local tool access: read, write, edit files and run commands"],
  },
};
