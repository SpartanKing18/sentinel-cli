...
const { defang, refang } = require("../toolkit/ioc");
const { assess: entropyAssess } = require("../toolkit/entropy");
const { inCidr, idHash } = require("../toolkit/scanutil");
const { portLookup, SERVICES } = require("../toolkit/ports");
const { parseUrl } = require("../toolkit/urlparse");
const { parseUA } = require("../toolkit/useragent");
const { cidrCalc } = require("../toolkit/scanutil");
const { convert: epochConvert } = require("../toolkit/epoch");
const { analyzeJwt } = require("../toolkit/jwt");
const { revshell } = require("../toolkit/revshell");
const { statusInfo } = require("../toolkit/httpstatus");
const { DORK_BASE, dorkUrls } = require("../toolkit/dorks");
const { CHEATS } = require("../toolkit/cheats");
const { ENC } = require("../toolkit/encoders");
const { genPassphrase, passphraseBits } = require("../toolkit/passphrase");
